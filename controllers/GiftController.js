...
//         lamports: parseInt(req.body.lamports),
//         senderBalanceAtTime: parseInt(req.body.senderBalanceAtTime) || 0,
//         token: req.body.token || 'BONK'
//       });
...
//       if (!giftId || !transactionSignature) {
//         return res.status(400).json({ 
//           success: false,
//           error: 'Missing giftId or transactionSignature' 
//         });
//       }

//       const completedGift = await Gift.complete(giftId, transactionSignature);
...
//   async _updatePostGiftCount(postId) {
//     if (!postId) return;
    
//     const postRef = db.collection('posts').doc(postId);
//     await postRef.update({
//       giftCount: db.FieldValue.increment(1),
